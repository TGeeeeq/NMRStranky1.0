...
export const galleryAnimals: GalleryAnimal[] = [
  { name: "Život na Louce", base: "louka", count: 22 },
  { name: "Procházky", base: "walk", count: 23 },
  { name: "Karel", base: "karel", count: 5 },
  { name: "Yakul", base: "yakul", count: 5 },
  { name: "Avala", base: "avala", count: 8 },
  { name: "Princezna", base: "princezna", count: 4 },
  { name: "Květa", base: "kveta", count: 8 },
  { name: "Riky", base: "riky", count: 2 },
  { name: "Flíček", base: "flicek", count: 3 },
  { name: "Atila", base: "atila", count: 6 },
  { name: "Kesu", base: "kesy", count: 6 },
  { name: "Pogo", base: "pogo", count: 4 },
  { name: "Kulich", base: "kulich", count: 3 },
  { name: "Eduard", base: "eduard", count: 5 },
  { name: "Emil", base: "emil", count: 1 },
  { name: "Amálka", base: "amalka", count: 2 },
  { name: "Končí", base: "konci", count: 4 },
  { name: "Lucinka", base: "lucinka", count: 4 },
  { name: "Anaya", base: "anaya", count: 2 },
  { name: "Malvína a Rozárka", base: "malvina", count: 4 },
  { name: "Zorka", base: "zorka", count: 3 },
  { name: "Roman", base: "roman", count: 5 },
  { name: "Máša", base: "masa", count: 3 },
  { name: "Lotka", base: "lotka", count: 4 },
  { name: "Denis", base: "denis", count: 6 },
  { name: "Hanička", base: "hanicka", count: 1 },
  { name: "Patricie", base: "patricie", count: 4 },
  { name: "Safír", base: "safir", count: 5 },
  { name: "Holoubci", base: "holoubci", count: 4 },
  { name: "Králíci", base: "kralici", count: 3 },
  { name: "Kachny", base: "kachny", count: 6 },
  { name: "Husy", base: "husy", count: 9 },
