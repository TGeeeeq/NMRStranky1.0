...
export const residents: Resident[] = [
  ...
  { name: "Pogo", image: "/assets/pogo1.webp", description: "Energická ovčí kamarádka." },
  ...
  { name: "Lucinka", image: "/assets/lucinka.webp", description: "Veselá a přátelská ovčí babička." },
