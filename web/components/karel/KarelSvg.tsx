...
export function KarelSvg({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 200 170" className={className} aria-hidden="true">
      ...
      {/* nohy — páry a/b se při chůzi (.karel-walking) houpou proti sobě */}
      <g className="karel-leg karel-leg-a">
        <rect x="56" y="112" width="12" height="42" rx="5.5" fill={C.body} />
        <rect x="56" y="146" width="12" height="9" rx="4" fill={C.hoof} />
      </g>
      <g className="karel-leg karel-leg-b">
        <rect x="76" y="115" width="12" height="40" rx="5.5" fill={C.body} />
        <rect x="76" y="147" width="12" height="9" rx="4" fill={C.hoof} />
      </g>
      <g className="karel-leg karel-leg-a">
        <rect x="102" y="115" width="12" height="40" rx="5.5" fill={C.body} />
        <rect x="102" y="147" width="12" height="9" rx="4" fill={C.hoof} />
      </g>
      <g className="karel-leg karel-leg-b">
        <rect x="120" y="112" width="12" height="42" rx="5.5" fill={C.body} />
        <rect x="120" y="146" width="12" height="9" rx="4" fill={C.hoof} />
      </g>
      ...
      {/* hlava vč. uší — společný „krční kloub" pro pózy (chomp, pasení, ne-ne) */}
